# Human Acceptance — claims-backoffice/web

- Evidence ID: `EVD-HUMAN-ACCEPTANCE-BACKOFFICE-WEB-001`
...
This evidence records the `claims-backoffice/web` portion of that explicit decision.
