...
const INITIAL_GOVERNED_BASELINE = 'b2f089476559795f30a3c0eec2b05fd0ac32531f';
...
const EARLIER_RELEASE_GATE_RECONCILIATION_MERGE = '50c77fec8482e87295ec7cfd4b800a132557a728';
const PRIOR_RELEASE_GATE_RECONCILIATION_MERGE = '06f730418518784246d8bf416260483ca4347290';
const CURRENT_RELEASE_GATE_RECONCILIATION_MERGE = 'cf91523041122f227b09f050cba742688b6f11b0';
const R3_RELEASE_COMMIT = '014b2a4c4c38d94b07346aaa54bc32a8bbb7c5f9';
const INITIAL_VFR_REVIEWED_COMMIT = 'a3f3d05656b1e5d8cd35368deec2e6b0e599fa7a';
const EARLIER_VFR_REVIEWED_COMMIT = '1f774dc4f3c0ce4a02b3c3caa664c78f304e7de1';
const PRIOR_VFR_REVIEWED_COMMIT = '37fb75846e0cd38a88d8773c937bc42d6c408d57';
const FRESH_VFR_REVIEWED_COMMIT = '498c04c8bfe3728c12c7f6b76d0ba3e26cb8a590';
const EARLIER_OBSERVABILITY_REVALIDATION_RUN = '35530710935';
const EARLIER_OBSERVABILITY_REVALIDATION_HEAD = 'bbb5a67a7757742b6ccc87e097dab91895eb324e';
const PRIOR_OBSERVABILITY_REVALIDATION_RUN = '35607410451';
const PRIOR_OBSERVABILITY_REVALIDATION_HEAD = '56e182f57c2509512f60d6585a5c490b76ffa05c';
const CURRENT_OBSERVABILITY_REVALIDATION_RUN = '35673365885';
const CURRENT_OBSERVABILITY_REVALIDATION_HEAD = 'ae4fb8b08d16b7ffa8b0fba8e26fef9a5aec078f';
...
for (const marker of [
  ...
  INITIAL_GOVERNED_BASELINE,
  EARLIER_GOVERNED_BASELINE,
  PRIOR_GOVERNED_BASELINE,
  CURRENT_GOVERNED_BASELINE,
  EARLIER_RELEASE_GATE_RECONCILIATION_MERGE,
  PRIOR_RELEASE_GATE_RECONCILIATION_MERGE,
  CURRENT_RELEASE_GATE_RECONCILIATION_MERGE,
  R3_RELEASE_COMMIT,
  INITIAL_VFR_REVIEWED_COMMIT,
  EARLIER_VFR_REVIEWED_COMMIT,
  PRIOR_VFR_REVIEWED_COMMIT,
  FRESH_VFR_REVIEWED_COMMIT,
  MACHINE_COMMIT,
  ...
  '34119017625',
  '35482185068',
  EARLIER_OBSERVABILITY_REVALIDATION_RUN,
  EARLIER_OBSERVABILITY_REVALIDATION_HEAD,
...
assert(isAncestor(R3_RELEASE_COMMIT, INITIAL_GOVERNED_BASELINE), 'initial Operations lineage checkpoint must descend from the R3 release');
assert(isAncestor(INITIAL_GOVERNED_BASELINE, EARLIER_GOVERNED_BASELINE), 'earlier Operations product checkpoint must descend from the initial governed checkpoint');
...
assert(isAncestor(INITIAL_VFR_REVIEWED_COMMIT, INITIAL_GOVERNED_BASELINE), 'initial Operations checkpoint must include the PR #132 VFR-reviewed product');
assert(isAncestor(EARLIER_VFR_REVIEWED_COMMIT, EARLIER_GOVERNED_BASELINE), 'earlier Operations checkpoint must include the PR #140 VFR-reviewed product');
assert(isAncestor(PRIOR_VFR_REVIEWED_COMMIT, PRIOR_GOVERNED_BASELINE), 'prior Operations checkpoint must include the PR #146 VFR-reviewed product');
assert(isAncestor(FRESH_VFR_REVIEWED_COMMIT, CURRENT_GOVERNED_BASELINE), 'current Operations checkpoint must include the fresh PR #152 VFR-reviewed product');
assert(isAncestor(EARLIER_GOVERNED_BASELINE, EARLIER_RELEASE_GATE_RECONCILIATION_MERGE), 'earlier Release Gate reconciliation merge must descend from the earlier Operations product checkpoint');
assert(isAncestor(EARLIER_OBSERVABILITY_REVALIDATION_HEAD, EARLIER_RELEASE_GATE_RECONCILIATION_MERGE), 'earlier Release Gate reconciliation merge must include the earlier Operations observability revalidation head');
assert(isAncestor(EARLIER_RELEASE_GATE_RECONCILIATION_MERGE, PRIOR_GOVERNED_BASELINE), 'prior Operations product checkpoint must descend from the earlier Release Gate reconciliation');
...
console.log(JSON.stringify({
  ...
  initialGovernedLineageCheckpoint: INITIAL_GOVERNED_BASELINE,
  ...
  earlierReleaseGateReconciliationMerge: EARLIER_RELEASE_GATE_RECONCILIATION_MERGE,
  ...
  earlierObservabilityRevalidationRun: EARLIER_OBSERVABILITY_REVALIDATION_RUN,
  earlierObservabilityRevalidationHead: EARLIER_OBSERVABILITY_REVALIDATION_HEAD,
