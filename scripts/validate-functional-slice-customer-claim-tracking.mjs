...
assert(['IN_PROGRESS', 'FUNCTIONAL', 'ACCEPTED'].includes(slice.lifecycle_status), 'tracking lifecycle must progress only through IN_PROGRESS, FUNCTIONAL or ACCEPTED');
